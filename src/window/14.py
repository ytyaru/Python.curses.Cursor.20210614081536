...
class Curses:
    ...
    def __main(cls, screen, *args, **kwargs):
        cls.main = kwargs['main'] if kwargs['main'] else CursesMain(screen)
        Cursor.hide()
...
class CursesMain:
    def __init__(self, screen):
        self.__wmng = WindowManager(screen)
...
#    def input(self, key): self.__wmng.Screen.getkey()
...
if __name__ == "__main__":
    ...
    term.get_parameter(term.get_capability('cup'), 5, 3)
