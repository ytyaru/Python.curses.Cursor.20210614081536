...
if __name__ == "__main__":
    ...
    def draw(wndMgr):
        ...
        wndMgr.Windows[0].draw(y=0, msg='Window-1', attr=curses.A_REVERSE | curses.color_pair(1))
        wndMgr.Windows[1].draw(y=1, msg='Window-2', attr=curses.A_REVERSE | curses.color_pair(2))
        curses.panel.update_panels()
    def loop(wndMgr):
        while True:
