...
if __name__ == "__main__":
    ...
    class KeyInput(Curses.Input):
        def input(self, key):
            ...
            return True
    def init():
#        pad_w = int(Curses.Terminal.W/3)
#        pad = Pad1(w=pad_w, h=Curses.Terminal.H*3)
#        subpad = SubPad1(pad, x=2, y=2, w=int(pad_w/2), h=int(Curses.Terminal.H*3/3))
#        win = Window1(x=pad_w+1, y=0, w=Curses.Terminal.W-(pad_w+1), h=Curses.Terminal.H)
